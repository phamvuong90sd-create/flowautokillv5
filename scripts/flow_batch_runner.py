...
def lock_window_geometry(page, width: int = 800, height: int = 600, left: int = 0, top: int = 0):
    """
...
def main():
    ...
    ap.add_argument("--window-width", type=int, default=800)
    ap.add_argument("--window-height", type=int, default=600)
