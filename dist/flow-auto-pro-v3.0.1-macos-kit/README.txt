Flow Auto Pro V3.0.1 by blackshop.xyz
...
Install:
  tar -xzf flow-auto-pro-v3.0.1-by-blackshop.xyz.tar.gz
  cd flow-auto-pro-v3.0.1-kit
  bash install.sh
...
- tên banner: Flow Auto Pro V3.0.1 by blackshop.xyz
