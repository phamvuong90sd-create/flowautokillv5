...
./.venv-build/bin/python -m PyInstaller --noconfirm --onefile --name FlowAutoStandalone --add-data "payload/scripts:payload/scripts" --collect-submodules urllib --collect-all playwright main.py
