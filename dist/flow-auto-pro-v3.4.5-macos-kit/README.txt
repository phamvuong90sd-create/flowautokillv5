Flow Auto Pro V3.4.5 by blackshop.xyz
...
Install:
  tar -xzf flow-auto-pro-v3.4.5-by-blackshop.xyz.tar.gz
  cd flow-auto-pro-v3.4.5-macos-kit
  bash install.sh
...
- tên banner: Flow Auto Pro V3.4.5 by blackshop.xyz
