...
./.venv-build/bin/python -m PyInstaller --noconfirm --windowed --name FlowAutoStandalone --icon assets/icon.icns --add-data "payload/scripts:payload/scripts" --collect-submodules urllib --collect-all playwright main.py
