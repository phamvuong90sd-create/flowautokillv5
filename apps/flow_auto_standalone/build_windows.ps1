...
.\.venv-build\Scripts\python -m PyInstaller --noconfirm --onefile --windowed --name FlowAutoStandalone --add-data "payload/scripts;payload/scripts" --collect-submodules urllib main.py
