...
./.venv-build/bin/python -m PyInstaller --noconfirm --windowed --target-arch x86_64 --name FlowAutoStandalone --icon assets/icon.icns --add-data "payload/scripts:payload/scripts" --collect-submodules urllib --collect-all playwright main.py
