; Flow Auto Video Pro V1.0 - Windows Installer (NSIS)
...
Name "Flow Auto Video Pro V1.0.1"
OutFile "FlowAutoVideoPro_v1.0.1_Setup.exe"
InstallDir "$PROFILE\.openclaw\flow-auto-video-pro-v1.0.1"
