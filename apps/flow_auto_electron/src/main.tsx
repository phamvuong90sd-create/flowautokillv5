...
function App(){
  ...
  async function activateLicense(){ const r=await window.flowAPI.activateLicense({licenseKey, apiBase}); const msg=friendly(r); setLicenseText(msg); append(msg); return r }
