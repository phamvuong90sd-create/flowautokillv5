Flow Auto Pro V4.0 by blackshop.xyz
...
Install:
  tar -xzf flow-auto-pro-v4.0-by-blackshop.xyz.tar.gz
  cd flow-auto-pro-v4.0-kit
  bash install.sh
...
- tên banner: Flow Auto Pro V4.0 by blackshop.xyz
