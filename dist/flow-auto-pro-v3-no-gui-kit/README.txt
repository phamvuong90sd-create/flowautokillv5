Flow Auto Pro V3 NO GUI by blackshop.xyz
...
Install:
  tar -xzf flow-auto-pro-v3 no gui-by-blackshop.xyz.tar.gz
  cd flow-auto-pro-v3 no gui-kit
  bash install.sh
...
- tên banner: Flow Auto Pro V3 NO GUI by blackshop.xyz
